  ...
  context "one-to-one relationships" do
    ...
    it "uses the correct properties on the base object and passes :short to any sub-objects for :public and :short properties" do
      3.times do
        ...
        @artwork.as_json({properties: :all}).should == { name: "Mona Lisa", image: { name: "Picture of Mona Lisa", nickname: "Mona", url: "http://art.sy/404.html" } }
        @image.as_json({properties: :short}).should == { name: "Picture of Mona Lisa", nickname: "Mona" }
        @image.as_json({properties: :public}).should == { name: "Picture of Mona Lisa", nickname: "Mona", url: "http://art.sy/404.html" }
      end
    end
    ...
    it "correctly updates fields when either the parent or child class changes" do
      ...
      3.times do
        ...
        @artwork.as_json({properties: :all}).should == { name: "Mona Lisa", image: { name: "Picture of Mona Lisa", nickname: "Worst Painting Ever", :url=>"http://art.sy/404.html" } }
      end
      ...
      3.times do
        ...
        @artwork.as_json({properties: :all}).should == { name: "Mona Lisa", image: { name: "Picture of Mona Lisa Watercolor", nickname: "Worst Painting Ever", :url=>"http://art.sy/404.html" } }
      end
    end
  end
